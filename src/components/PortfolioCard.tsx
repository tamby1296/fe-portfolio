  ...
  return (
    <div className="lg:w-1/3 flex-shrink p-2 relative overflow-hidden">
      <a href={link} target="_blank" rel="noreferer noopener" className="group w-full">
        ...
        <div className="translate-y-[100%] transition duration-500 group-hover:translate-y-0 text-center mx-auto absolute top-0 bg-kAppGrey bg-opacity-80 w-[calc(100%-16px)] h-full p-2">
