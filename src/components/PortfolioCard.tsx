export const PortfolioCard = () => {
  return (
    <div className="lg:w-1/3 flex-shrink p-2">
      <a href="http://www.google.mu" target="_blank" rel="noreferer noopener" className="w-full">
        <img src="https://placehold.co/370x302" alt="my-img" className="w-full rounded-xl flex-grow" />
